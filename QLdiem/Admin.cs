...
namespace QLdiem
{
    public partial class Admin : Form
    {
        ...
        private void createConnection()
        {
            try
            {
                String stringConnection = "Server=DESKTOP-TMCDUUR\\LUCKDAT;Database=QLdiem; Integrated Security = true";
        ...
        private void tbMaSV1_TextChanged(object sender, EventArgs e)
        {
